...
export default function Navbar() {
  return (
    <nav className="flex flex-row w-full text-white bgc_blue justify-between pt-3 pb-3 pl-20 gap-12 navbar">
      <a href="">
        <img
      ...
      <ul className="flex flex-row w-full justify-center gap-9 font-semibold text-lg ml-20 pl-12 items-center">
        ...
        <li>
          <button className="flex bgc_yellow rounded-sm w-30 h-10 p-4 text-center justify-center items-center hover:text-black">
            INTRANET
          </button>
        </li>
      </ul>
