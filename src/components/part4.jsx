...
export default function Part4(){
    return <div className='flex flex-row justify-evenly gap-2 w-full h-screen color_blue text-lg pt-10'>
        ...
        <section className='w-1/3'>
            <img src="https://hei.school/wp-content/uploads/2024/11/IMG-02-e1720543344824-987x1024-1.webp" className='w-full h-3/4' alt="" />
        </section>
    </div>
}