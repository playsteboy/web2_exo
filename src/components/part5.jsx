...
export default function Part5(){
    return <div className='w-full h-screen color_blue bg-neutral-100 text-center font-semibold flex flex-col gap-5'>
        ...
        <section className='w-full h-5/6 flex flex-row items-center justify-center gap-6 text-center'>
            <div className='w-1/4 h-5/6 flex flex-col items-center bg-white rounded-2xl p-5 gap-5'>
                ...
                <h1 className='color_yellow font-bold text-xl'>Cloud et cybersecurite</h1>
                <p>
            ...
            <div className='w-1/4 h-5/6 flex flex-col items-center bg-white rounded-2xl p-5 gap-5'>
                ...
                <h1 className='color_yellow font-bold text-xl'>Intelligence artificielle</h1>
                <p>
            ...
            <div className='w-1/4 h-5/6 flex flex-col items-center bg-white rounded-2xl p-5 gap-5'>
                ...
                <h1 className='color_yellow font-bold text-xl'>Ingenerie logicielle</h1>
                <p>
