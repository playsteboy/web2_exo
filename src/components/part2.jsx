...
export default function Part2() {
  return (
    <div className="flex flex-row justify-between w-full pt-20 pr-48 color_blue text-lg pb-20">
      ...
      <section className="w-1/2 h-full pr-14 flex flex-col justify-between gap-10 ">
        ...
        <div className="flex flex-col gap-5">
          <h2 className="text-2xl font-bold ml-5 ">
            <i class="fa-solid fa-graduation-cap color_yellow text-5xl"></i>
            &nbsp;+3ans
          </h2>
          <p>
        ...
        <div className="flex flex-col gap-5">
          <h2 className="text-2xl font-bold ml-5 ">
            <i class="fa-solid fa-users color_yellow text-5xl"></i>&nbsp;+250
            etudiants
          </h2>
          <p>
        ...
        <div className="flex flex-col gap-5">
          <h2 className="text-2xl font-bold ml-5 ">
            <i class="fa-solid fa-medal color_yellow text-5xl"></i>&nbsp; Notre
            mission
          </h2>
          <p>
