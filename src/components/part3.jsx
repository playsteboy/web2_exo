        ...
        <div className="slide2_container h-full flex flex-row overflow-hidden items-center justify-between gap-7">
          <div className="slide2_content rounded-2xl">
            <div className="slide2_profile">
              <img
                src="https://hei.school/wp-content/uploads/2025/05/Mirado-150x150.webp"
          ...
          <div className="slide2_content rounded-2xl">
            <div className="slide2_profile">
              <img
                src="https://hei.school/wp-content/uploads/2025/05/Julien-150x150.webp"
                className="slide2_img"
                alt=""
              />
            </div>
          ...
          <div className="slide2_content rounded-2xl">
            <div className="slide2_profile">
              <img
                src="https://hei.school/wp-content/uploads/2025/03/ryan-min-150x150.webp"
                className="slide2_img"
                alt=""
              />
            </div>
            ...
            <p className="mt-2">
              Developpeur back-end | confondateur et directeur des operations de
              HEI
            </p>
          </div>
          ...
          <div className="slide2_content rounded-2xl">
            <div className="slide2_profile">
              <img
                src="https://hei.school/wp-content/uploads/2022/01/Jean-Aime-Maxa-modified-150x150.jpg"
                className="slide2_img"
                alt=""
              />
            </div>
            ...
            <p className="mt-2">
              Responsable technique cybersecurte ches CES France Continental
              (Toulose-France)
            </p>
          </div>
          ...
          <div className="slide2_content rounded-2xl">
            <div className="slide2_profile">
              <img
                src="https://hei.school/wp-content/uploads/2022/01/Parison-e1716502987165-150x150.png"
                className="slide2_img"
                alt=""
              />
            </div>
            ...
            <p className="mt-2">
              Ingeieur en informatique | ingenieur logiciel chez google
              (Londre-UK)
            </p>
          </div>
          ...
          <div className="slide2_content rounded-2xl">
            <div className="slide2_profile">
              <img
                src="https://hei.school/wp-content/uploads/2022/01/5746AC1E761A42D1B7D89496C9A6BE9B_edited-e1716502720974-150x150.jpg"
                className="slide2_img"
                alt=""
              />
            </div>
          ...
          <div className="slide2_content rounded-2xl ">
            <div className="slide2_profile">
              <img
                src="https://hei.school/wp-content/uploads/2022/01/Tahina-OK-e1716502943928-150x150.png"
                className="slide2_img"
                alt=""
              />
            </div>
            ...
            <p className="mt-2">
              Docteure-ingenieure , CNRS France | Prix l'Oreal-UNESCO pour les
              femmes en science (2017)
            </p>
          </div>
          ...
          <div className="slide2_content rounded-2xl">
            <div className="slide2_profile">
              <img
                src="https://hei.school/wp-content/uploads/2022/01/97-portraits-97_edited-e1716502895676-150x150.jpg"
                className="slide2_img"
                alt=""
              />
            </div>
            ...
            <p className="mt-2">
              Docteur-ingenieur en informatique | fondateur directeur
              pedagogique de HEI
            </p>
          </div>
        </div>
